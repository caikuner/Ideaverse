...
- 三月份家里确实有急事，回家两个多月，然后回北京才开始准备
- 一开始对自己要求比较高，基本也都是在看大厂的机会，想找一个理想、符合自己需求的工作
  - 全栈相关，比纯前端有更多的机会
  - AI 相关符合趋势，一直没有合适的机会。
...
- 公司平台大，有更多的机会
- 团队业务是全栈、前端、安全相关，我对这个也有兴趣，也和我之前的经历比较适配
...
- 喜欢一个有技术氛围的团队，大家可以一起研究相关技术、一起成长进步
...
- 首先就是提升技术的深度和项目的整体把控能力
- 承担更重要的职责，像我之前在的部门，其实策略和工程分的比较开，不关心业务收益，后面希望更难贴合业务
- 完成好公司项目，提高项目的整体把控能力

### 如何看待加班？

还可以吧，职责所在，真的需要加班来达成项目目标的时候是可以接受的。像我做一站式风控项目的时候，其实加班还蛮严重的，因为一期上线时间排的紧，甚至好几个周六都在加班，还有一次通宵。但真正需要的情况下，是完全可以的。
...
可选的词：`专注` `计划性` `时间观念强`
`执行力` `热情` `积极` `创造性` `极客精神`  `善于沟通` `乐于分享` `组织能力` `管理能力` 
...
- 发送邮件和会邀给全体参会人员，抄送相关领导
- 制定会议议程，需要各方评审的重要会议至少提前半天发送文档
- 主持会议，保证讨论话题的方向（不要蔓延到其他话题），做会议记录
- 会议结束，整体会议记录和决议，发送邮件
