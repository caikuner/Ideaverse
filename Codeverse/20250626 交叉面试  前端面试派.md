...
## 求两个数组的交集和并集 [[https://www.mianshipai.com/docs/third-exam/cross-test.html#求两个数组的交集和并集]]
...
## 数组转树 [[https://www.mianshipai.com/docs/third-exam/cross-test.html#数组转树]]
...
## 树转数组 [[https://www.mianshipai.com/docs/third-exam/cross-test.html#树转数组]]
...
## cookie localStorage sessionStorage 三者有什么区别，有什么应用场景？ [[https://www.mianshipai.com/docs/third-exam/cross-test.html#cookie-localstorage-sessionstorage-三者有什么区别-有什么应用场景]]
...
| --- | --- | --- | --- |
| 写入方式 | 服务端和前端都可写入，不过 http-only 情况下只允许服务端写入 | 前端 | 前端 |
...
## 前端会有哪些安全问题？该如何预防？ [[https://www.mianshipai.com/docs/third-exam/cross-test.html#前端会有哪些安全问题-该如何预防]]
...
## 常见的 git 命令有哪些？ [[https://www.mianshipai.com/docs/third-exam/cross-test.html#常见的-git-命令有哪些]]
...
## 如何使用 git 多人协作开发？ [[https://www.mianshipai.com/docs/third-exam/cross-test.html#如何使用-git-多人协作开发]]
...
## 是否熟悉 Linux 系统，常见的 Linux 命令有哪些？ [[https://www.mianshipai.com/docs/third-exam/cross-test.html#是否熟悉-linux-系统-常见的-linux-命令有哪些]]
...
## 如何调试前端代码？ [[https://www.mianshipai.com/docs/third-exam/cross-test.html#如何调试前端代码]]
...
## 移动端 H5 如何抓包网络请求？ [[https://www.mianshipai.com/docs/third-exam/cross-test.html#移动端-h5-如何抓包网络请求]]
...
## 网页重绘 repaint 和重排 reflow 有什么区别 [[https://www.mianshipai.com/docs/third-exam/cross-test.html#网页重绘-repaint-和重排-reflow-有什么区别]]
...
- **重绘（Repaint）** 重绘是指当元素的样式发生改变，但不影响布局时触发的渲染过程。 **触发条件** ：颜色、背景、边框等视觉样式的变化。
...
- **重排（Reflow）** 重排（又称回流）是指当页面布局或结构发生变化时，浏览器重新计算元素的位置和几何尺寸的过程。 **触发条件** ：DOM 节点的增删、元素位置的变化、盒模型属性（如 `width`, `height`, `padding` 等）的修改。
...
## 网页多标签页之间如何通讯？和 iframe 如何通讯？ [[https://www.mianshipai.com/docs/third-exam/cross-test.html#网页多标签页之间如何通讯-和-iframe-如何通讯]]
...
## 什么是 axios 拦截器，能用来做什么？ [[https://www.mianshipai.com/docs/third-exam/cross-test.html#什么是-axios-拦截器-能用来做什么]]
...
- **添加通用请求头** 可以统一为所有请求添加认证 Token、语言信息等。
...
- **全局错误处理** 统一处理服务器返回的错误，如用户未登录、网络错误等。
...
- **数据格式预处理** 对服务器返回的数据进行格式化，比如从 API 响应中提取有效数据部分。
...
- **拦截器顺序** ： 请求拦截器会按添加顺序执行，而响应拦截器按相反顺序执行。
- **错误处理机制** ： 错误处理函数需要显式调用 `Promise.reject(error)`，否则错误可能被吞掉。

## 是否熟悉 Performance API ，是否了解常见的性能指标？ [[https://www.mianshipai.com/docs/third-exam/cross-test.html#是否熟悉-performance-api-是否了解常见的性能指标]]
...
## sourcemap 有何作用，如何配置？ [[https://www.mianshipai.com/docs/third-exam/cross-test.html#sourcemap-有何作用-如何配置]]
...
## 什么是 HTTPS 中间人攻击，如何预防 [[https://www.mianshipai.com/docs/third-exam/cross-test.html#什么是-https-中间人攻击-如何预防]]
...
## 什么是 OOP ，面向对象三要素是什么？ [[https://www.mianshipai.com/docs/third-exam/cross-test.html#什么是-oop-面向对象三要素是什么]]
...
## 你知道哪些前端或 JS 工具链？它们分别什么作用？ [[https://www.mianshipai.com/docs/third-exam/cross-test.html#你知道哪些前端或-js-工具链-它们分别什么作用]]
