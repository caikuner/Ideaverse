...
## DOCTYPE 是什么，都有哪些属性？ [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#doctype-是什么-都有哪些属性]]
...
## 什么是 DOM ，它和 HTML 有什么区别？ [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#什么是-dom-它和-html-有什么区别]]
...
## 如何理解 HTML5 语义化 ？有哪些常见的语义化标签？ [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#如何理解-html5-语义化-有哪些常见的语义化标签]]
...
## DOM 节点的 attr 和 property 有何区别 [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#dom-节点的-attr-和-property-有何区别]]
...
## 如何一次性插入多个 DOM 节点？考虑性能 [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#如何一次性插入多个-dom-节点-考虑性能]]
...
## HTMLCollection 和 NodeList 的区别 [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#htmlcollection-和-nodelist-的区别]]
...
## Node 和 Element 有什么区别？ [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#node-和-element-有什么区别]]
...
## 开发一个无限下拉加载图片的页面，如何给每个图片绑定 click 事件？ [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#开发一个无限下拉加载图片的页面-如何给每个图片绑定-click-事件]]
...
## window.onload 和 DOMContentLoaded 的区别是什么？ [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#window-onload-和-domcontentloaded-的区别是什么]]
...
## script 标签放在 head 里，怎么解决加载阻塞的问题 [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#script-标签放在-head-里-怎么解决加载阻塞的问题]]
...
1. 使用 `defer` 属性。`defer` 属性使得脚本延迟执行，直到 HTML 文档解析完毕。这意味着脚本不会阻塞 HTML 渲染，且会按照文档中 `<script>` 标签的顺序执行。适用于依赖 DOM 元素的脚本（如操作页面内容）。
...
1. 将 `<script>` 放在 `<body>` 最后。

## 常见的 HTML 标签哪些是 inline 元素，哪些是 block 元素，哪些是 inline-block 元素 [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#常见的-html-标签哪些是-inline-元素-哪些是-block-元素-哪些是-inline-block-元素]]
...
## 常见的 CSS 选择器有哪些？ [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#常见的-css-选择器有哪些]]
...
## CSS 盒子模型，尺寸计算 [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#css-盒子模型-尺寸计算]]
...
`offsetWidth` 是指 `元素内容 + 内间距 + 边框` 的距离，不包括外间距
...
## margin 纵向重叠 [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#margin-纵向重叠]]
...
## lineHeight 如何继承？ [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#lineheight-如何继承]]
...
## margin 负值问题 [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#margin-负值问题]]
...
## 什么是 CSS 定位上下文？absolute 和 relative 分别依据谁来定位？ [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#什么是-css-定位上下文-absolute-和-relative-分别依据谁来定位]]
...
## CSS `px` `%` `em` `rem` `vw/vh` 的区别 [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#css-px-em-rem-vw-vh-的区别]]
...
## 如何实现黑白主题变化？ [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#如何实现黑白主题变化]]
...
## 如何实现响应式布局？ [[https://www.mianshipai.com/docs/first-exam/HTML-CSS.html#如何实现响应式布局]]
...
1. 使用弹性盒子（Flexbox）。创建水平或垂直方向上的自适应布局，比如导航栏、网格布局。
...
1. 使用网格布局（CSS Grid Layout）。 创建复杂的自适应网格布局，比如图片库、商品列表。
...
1. 使用百分比和单位 vh/vw 实现宽度和高度的自适应。实现宽度和高度随窗口变化而调整。
