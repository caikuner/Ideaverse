...
```
const url = "https://www.example.com/search?query=你好";const encodedURL = encodeURIComponent(url);console.log(encodedURL);// 输出: https%3A%2F%2Fwww.example.com%2Fsearch%3Fquery%3D%E4%BD%A0%E5%A5%BD
```

这可以确保 `URL` 传输时不会因字符编码不同而出现问题，从而提高兼容性和稳定性。如下输出所示：

![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-LZhh88gCqY.png|20250314092027]]
...
```
<html lang="zh">  <head>    <meta charset="utf-8" />    <meta name="viewport" content="width=device-width, initial-scale=1" />    <!-- 预解析 Google Fonts 以加快字体加载 -->    <link rel="dns-prefetch" href="https://fonts.googleapis.com/" />    <!-- 其他 head 元素 --></head><body>    <!-- 页面内容 --></body></html>
```
...
```
<!-- 提前建立连接，减少延迟 --><link rel="preconnect" href="https://fonts.googleapis.com/" crossorigin /><!-- 预解析 DNS，确保解析速度 --><link rel="dns-prefetch" href="https://fonts.googleapis.com/" />
```
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-F7iOs219pA.png|20250314094544]]
...
1. 启动渲染进程：当浏览器决定 **创建新的渲染进程** 时，浏览器进程会执行以下操作：
...
1. 渲染进程解析 HTML，构建 DOM 树，加载 CSS 并生成 StyleSheets，执行 布局计算和绘制，最终交由 GPU 进程渲染并显示到屏幕。
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-MnlubbmHSE.png|20250316121226]]
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-8NkOLzaJR8.png|20250316121357]]
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-bnbVMu7Hzk.png|20250316122132]]
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-Sxbr7Bu0c2.png|20250316122508]]
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-r7ZsL4xZxT.png|20250316122441]]
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-nEolahT9BP.png|20250316122929]]
...
```
body {font-size: 20px;}p {color: blue;}span {display: none;}div {font-weight: bold;color: red;}divp {color: green;}
```

这张样式表最终应用到 DOM 节点的效果如下图所示:

![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-EWiPzFr5lG.png|20250316122957]]
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-u5GdhIUd27.png|20250316134403]]
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-u0E2kmG7GN.png|20250316134542]]
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-uzZnVD4IiY.png|20250316135117]]

20250316135117

如下图所示，它是主线程遍历布局树并生成层次结构：

![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-yzw3YsYORf.png|20250316135312]]
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-3fnpRSQnL9.png|20250316135501]]
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-ItFhoYJK8r.png|20250316140339]]
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-f4szWnmm1O.png|20250316140438]]
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-2w7CS6Ti8P.png|20250316141911]]
...
![[从输入 URL 到浏览器展示，到底经历了什么 （超级详细！）-xMYNfvld6o.png|渲染流程]]
