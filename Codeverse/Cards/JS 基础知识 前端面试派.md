...
- [https://juejin.cn/post/7459351912133132351](https://juejin.cn/post/7459351912133132351)

## `typeof` 能判断哪些类型 [[https://www.mianshipai.com/docs/first-exam/JS.html#typeof-能判断哪些类型]]
...
## `==` 和 `===` 有什么区别？ [[https://www.mianshipai.com/docs/first-exam/JS.html#和-有什么区别]]
...
## 你熟悉哪些数组 API ？ [[https://www.mianshipai.com/docs/first-exam/JS.html#你熟悉哪些数组-api]]
...
## 值类型和引用类型的区别 [[https://www.mianshipai.com/docs/first-exam/JS.html#值类型和引用类型的区别]]
...
## for…in 和 for…of 的区别 [[https://www.mianshipai.com/docs/first-exam/JS.html#for-in-和-for-of-的区别]]
...
## JS 原型和原型链 [[https://www.mianshipai.com/docs/first-exam/JS.html#js-原型和原型链]]

参考答案

Details

![[JS 基础知识  前端面试派-FOOXNbBqLj.jpeg|proto]]
...
## JS 继承有几种方式？ [[https://www.mianshipai.com/docs/first-exam/JS.html#js-继承有几种方式]]
...
✅ **优点：** 1. 继承属性和方法，2. 只调用一次 `Parent` ❌ **缺点：** 代码略微复杂
...
✅ **优点：** 语法更清晰，易读易用 ❌ **缺点：** 本质仍是 `prototype` 继承

## JS 作用域和作用域链 [[https://www.mianshipai.com/docs/first-exam/JS.html#js-作用域和作用域链]]
...
## JS 自由变量，如何理解 [[https://www.mianshipai.com/docs/first-exam/JS.html#js-自由变量-如何理解]]
...
## JS 闭包，如何理解 [[https://www.mianshipai.com/docs/first-exam/JS.html#js-闭包-如何理解]]
...
## 同步和异步有什么区别？异步的意义是什么？ [[https://www.mianshipai.com/docs/first-exam/JS.html#同步和异步有什么区别-异步的意义是什么]]
...
## JS Promise 有几种状态？如何变化 [[https://www.mianshipai.com/docs/first-exam/JS.html#js-promise-有几种状态-如何变化]]
...
## JS Promise 使用 [[https://www.mianshipai.com/docs/first-exam/JS.html#js-promise-使用]]
...
## async/await 使用 [[https://www.mianshipai.com/docs/first-exam/JS.html#async-await-使用]]
...
## 宏任务和微任务的区别 [[https://www.mianshipai.com/docs/first-exam/JS.html#宏任务和微任务的区别]]
...
## 描述 Event Loop 运行机制 [[https://www.mianshipai.com/docs/first-exam/JS.html#描述-event-loop-运行机制]]

参考答案

Details

![[JS 基础知识  前端面试派-lW2hByZgMf.png|eventloop]]
...
## Set 和 Array 有什么区别 [[https://www.mianshipai.com/docs/first-exam/JS.html#set-和-array-有什么区别]]
...
## Map 和 Object 有什么区别 [[https://www.mianshipai.com/docs/first-exam/JS.html#map-和-object-有什么区别]]
...
## setTimeout、requestAnimationFrame 和 requestIdleCallback 有什么区别 [[https://www.mianshipai.com/docs/first-exam/JS.html#settimeout、requestanimationframe-和-requestidlecallback-有什么区别]]
...
## 写一个验证 email 的正则表达式 [[https://www.mianshipai.com/docs/first-exam/JS.html#写一个验证-email-的正则表达式]]
...
## JS 模块化规范有哪些？ [[https://www.mianshipai.com/docs/first-exam/JS.html#js-模块化规范有哪些]]
...
## `0.1 + 0.2 === 0.3` 表达式返回什么？ [[https://www.mianshipai.com/docs/first-exam/JS.html#_0-1-0-2-0-3-表达式返回什么]]
...
**原因：** JavaScript 中的浮点数运算存在精度问题。由于计算机在内部表示浮点数时不能精确表示某些小数，导致 `0.1 + 0.2` 的结果并不是精确的 `0.3`，而是一个接近于 `0.3` 的小数。
...
## 如何检测 JS 内存泄漏？内存泄漏的场景有哪些？ [[https://www.mianshipai.com/docs/first-exam/JS.html#如何检测-js-内存泄漏-内存泄漏的场景有哪些]]
...
## JS V8 Nodejs Deno Bun 这几个，他们是什么关系？ [[https://www.mianshipai.com/docs/first-exam/JS.html#js-v8-nodejs-deno-bun-这几个-他们是什么关系]]
...
## 有了解过 WeakMap 吗？WeakMap 与 Map 的区别是什么？ [[https://www.mianshipai.com/docs/first-exam/JS.html#有了解过weakmap吗-weakmap与map的区别是什么]]
