...
**Counter**
If a categorizing framework is set up to be fluid, it is not top down. Notes do not have to fit its structure. There is no compromise. In the case of a Home note, it's a pre-existing structure that you can tether to only when you care to. _It adds context without limiting access._
...
[^2]: But if you have Boolean searches to your notes, it _mostly_ can mitigate the scaling problem—then you'd just have to remember the correct tags, which in practice isn't a certainty.
